    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while ((countCurrentLine = br.readLine()) != null) {
                ...
                String Alias = countCurrentLine.split(",")[2];
                ...
                if (rs.next()) {
                    ...
                    if (!Alias.replaceAll(" ", "").equals(rs.getString(3).replaceAll(" ", ""))) {
                        statement.executeUpdate("Update [dbo].[Pedigree] set [Alias2] = '" + Alias.replaceAll(" ", "") + "' where ID = " + rs.getInt(1));
                    }
                } else {
                    statement.executeUpdate("INSERT INTO [dbo].[Pedigree] ([Name],[Alias1]) VALUES('" + Name.replaceAll(" ", "") + "','"+Alias+"' )");
