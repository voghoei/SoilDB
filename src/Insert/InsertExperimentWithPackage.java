...
public class InsertExperimentWithPackage {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            br = new BufferedReader(new FileReader("D:\\Soil Files\\2018\\Experiment\\Genomes2Fields.csv"));
            int counter = 0;
            br.readLine();
...
//                                Treatment_ID = rs.getInt(1);                                
                                    ...
                                    if (rs.next()) {
                                        Rep_ID = rs.getInt(1);
                                        String q= "INSERT INTO [dbo].[ExperimentDetails] ([ExperimentType_ID],[location_ID],[Rep_ID],[Plot_ID],[Year],[Note],Treatment_ID) VALUES(" + ExperimentType_ID + "," + Origin_ID + "," + Rep_ID + ",'" + Plot_ID + "',18,'" + Note + "',null)";
                                        statement.executeUpdate("INSERT INTO [dbo].[ExperimentDetails] ([ExperimentType_ID],[location_ID],[Rep_ID],[Plot_ID],[Year],[Note],Treatment_ID) VALUES(" + ExperimentType_ID + "," + Origin_ID + "," + Rep_ID + ",'" + Plot_ID + "',18,'" + Note + "',null)");
                                    } else {
                                        statement.executeUpdate("INSERT INTO [dbo].[ExperimentDetails] ([ExperimentType_ID],[location_ID],[Rep_ID],[Plot_ID],[Year],[Note],Treatment_ID) VALUES(" + ExperimentType_ID + "," + Origin_ID + ",Null,'" + Plot_ID + "',18,'" + Note + "',null)");
                                    }
                                    counter++;
                                    //Experiment
                                    ...
                                    if (rs.next()) {
                                        ...
                                        statement.executeUpdate("INSERT INTO [dbo].[ExperimentPlot] ([Package_ID],[Out_ID],[ExperimentDetails_ID],[Person_ID],[Date],[SeedRemove],[Note]) VALUES(" + Package_ID + ",null," + Experiment_ID + ",1,'2018-04-27'," + SeedNo + ",'')");
