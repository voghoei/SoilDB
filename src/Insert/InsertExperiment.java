...
public class InsertExperiment {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            br = new BufferedReader(new FileReader("E:\\2016 winter data\\Soil\\2017\\Package info\\SeedTreatments.csv"));
            int counter = 0;
            br.readLine();
            while ((countCurrentLine = br.readLine()) != null) {
                ...
                String FileOrigin = "Patric Ag Chemical";
                ...
                int SeedNo = 100; //countCurrentLine.split(",")[11];
                    ...
                    if (rs.next()) {
                        ...
                        if (rs.next()) {
                            ...
                            if (rs.next()) {
                                ...
                                //Package
                                rs = statement.executeQuery("select ID from View_Package where Name = '" + Name + "' and Origin = '" + FileOrigin + "'");
                                if (rs.next()) {
                                    ...
                                    if (rs.next()) {
                                        Rep_ID = rs.getInt(1);
                                        statement.executeUpdate("INSERT INTO [dbo].[Experiment1] ([ExperimentType_ID],[location_ID],[Rep_ID],[Plot_ID],[Year],[Note],Treatment_ID) VALUES(" + ExperimentType_ID + "," + Origin_ID + "," + Rep_ID + ",'" + Plot_ID + "',17,'" + Note + "',"+Treatment_ID+")");
                                    } else {
                                        statement.executeUpdate("INSERT INTO [dbo].[Experiment1] ([ExperimentType_ID],[location_ID],[Rep_ID],[Plot_ID],[Year],[Note],Treatment_ID) VALUES(" + ExperimentType_ID + "," + Origin_ID + ",Null,'" + Plot_ID + "',17,'" + Note + "',"+Treatment_ID+")");
                                    }
                                    counter++;
                                    //Experiment
                                    ...
                                    if (rs.next()) {
                                        ...
                                        statement.executeUpdate("INSERT INTO [dbo].[PackageWithdrawal1] ([Package_ID],[Out_ID],[Experiment_ID],[Person_ID],[Date],[SeedRemove],[Note]) VALUES(" + Package_ID + ",null," + Experiment_ID + ",1,CONVERT (date, GETDATE())," + SeedNo + ",null)");
