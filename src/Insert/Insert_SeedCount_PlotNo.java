...
public class Insert_SeedCount_PlotNo {
     public static void main(String[] args) {
        ...
        try {
            ...
            br = new BufferedReader(new FileReader("D:\\Soil Files\\2017\\Harvest\\Seed Harvest filan check.csv"));
            br.readLine();
            while ((countCurrentLine = br.readLine()) != null) {
                ...
                String q = "select [ExperimentPlot_ID] from [View_FieldMap] where [Destination] like '%" + PlotNo + "%' ";
                ...
                if (rs.next()) {
                    ...
                    if(Note.length() > 0){
                        Query = "insert into FieldBook(FieldMap_ID,Phenotype_ID,Value,Date,Note) values (" + FieldMap_ID + ",9, '" + SeedCount + "','2017-11-16 10:00:00.000','"+Note+"')";
                    
                    }else{
                        Query = "insert into FieldBook(FieldMap_ID,Phenotype_ID,Value,Date) values (" + FieldMap_ID + ",9, '" + SeedCount + "','2017-11-16 10:00:00.000')";
